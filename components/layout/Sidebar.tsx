...
const nav = [
  ...
  { href: '/admin/rooms', label: 'Rooms & Pricing', badge: null,
  ...
  { href: '/admin/packages', label: 'Event Packages', badge: null,
  ...
  { href: '/admin/memberships', label: 'Fitness Memberships', badge: null,
